...
class GeneMapper:
    ...
    def __init__(self, species='hsa'):
        ...
        self.database = hgnc
        # hgnc
        self.gene_name_to_uniprot = convert_to_dict(hgnc, 'symbol',
                                                    'uniprot_ids')
        self.gene_name_to_alias_name = convert_to_dict(hgnc, 'symbol',
                                                       'alias_name')
        self.gene_name_to_ensembl = convert_to_dict(hgnc, 'symbol',
                                                    'ensembl_gene_id')
        self.gene_name_to_kegg = None

        self.uniprot_to_gene_name = convert_to_dict(hgnc, 'uniprot_ids',
                                                    'symbol')
